 ...
 */
final class Version20230704093815 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE music CHANGE release_date realease_date DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE music CHANGE realease_date release_date DATE NOT NULL');
    }
}
